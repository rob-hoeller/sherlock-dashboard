  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden max-h-[80vh] overflow-y-auto">
          {digests.map((d) => {
          ...
          {digests.length === 0 && (
            <p className="px-4 py-8 text-zinc-500 dark:text-zinc-600 text-sm text-center">No digests found</p>
          )}
        </div>

        <div className="lg:col-span-2 bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-6 max-h-[80vh] overflow-y-auto">
          {selected ? (
            <>
